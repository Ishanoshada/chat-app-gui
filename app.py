...
# Welcome widgets
welcome_label = tk.Label(app, text="Welcome to the Chat App!")
welcome_label.pack()

login_button_ = tk.Button(app, text="Login", command=show_login_interface)
login_button_.pack()

signup_button_ = tk.Button(app, text="Signup", command=show_signup_interface)
signup_button_.pack()
...
# Chat widgets
chat_label = tk.Label(app, text="Chat:")
chat_text = tk.Text(app, state=tk.DISABLED)
